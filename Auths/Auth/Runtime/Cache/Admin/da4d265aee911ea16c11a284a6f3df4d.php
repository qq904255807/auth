...
<script src="/Auths/Public/Common/Echarts/echarts.js"></script>
<script>
    // Step:3 为模块加载器配置echarts的路径，从当前页面链接到echarts.js，定义所需图表路径
    require.config({
        paths: {
            echarts: '/Auths/Public/Common/Echarts'
        }
    });
...
<div class="nav">
	<div class="nav_title">
    	<h4><img class="nav_img" src="/Auths/Public/Admin/img/tab.gif" /><span class="nav_a">后台首页</span></h4>
    </div>
</div>
