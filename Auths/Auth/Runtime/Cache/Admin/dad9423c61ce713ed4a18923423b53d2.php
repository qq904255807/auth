...
function admin_add(){
		...
		$.post(	"/Auths/index.php/Admin/admin/admin_add/menu_title/%E5%90%8E%E5%8F%B0%E7%AE%A1%E7%90%86%20-%20%E7%94%A8%E6%88%B7%E6%B7%BB%E5%8A%A0",{"account":account,"password":password,"group_id":group_id},function(data){
				if(data == 1){
...
<div class="nav">
	<div class="nav_title">
    	<h4><img class="nav_img" src="/Auths/Public/Admin/img/tab.gif"><span class="nav_a">添加管理员</span></h4>
    </div>
</div>
<div class="list">
